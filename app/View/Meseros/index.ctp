...
<table>
	...
	<tr>
		...
		<td> <?php echo $this->Form->postLink('Eliminar', array('action' => 'eliminar', $mesero['Mesero']['id']), array('confirm'=>'Eliminar a: '.$mesero['Mesero']['nombre'].' '. $mesero['Mesero']['apellido'].'?')); ?> </td>
	</tr>
